package com.mgcc.rpsiel.infrastructure.services.excel.template;
...
public class ExcelTemplate {
  ...
  public void createEtat(Person person) {
    ...
    try (OutputStream outStream = new FileOutputStream(
        Paths.get(ioPaths.getOutput(), person.getFullName(), "ES_" + person.getFullName() + ".xls").toString())) {
      ...
      JxlsHelper.getInstance().processTemplate(loadResource("templates/Etat.xls"), outStream, context);
